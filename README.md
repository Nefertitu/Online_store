...
[Главная страница]: http://127.0.0.1:8000/base/

[Контакты]: http://127.0.0.1:8000/contacts/

[Страница с информацией о товаре]: http://127.0.0.1:8000/base/id/
(на данный момент id = [1, 2, 3, 6, 7, 8, 9, 10, 11, 12, 18])

[Добавить товар]: http://127.0.0.1:8000/add_product/

[Товар успешно добавлен]: http://127.0.0.1:8000/success/
